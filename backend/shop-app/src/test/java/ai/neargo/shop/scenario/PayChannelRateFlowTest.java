...
class PayChannelRateFlowTest {
    ...
    void noRateReturnsNullNotZero() {
        assertThat(rates.effective(SysPayChannelRate.ANY, "NOPE-CH", "*", "*", System.currentTimeMillis()))
                .as("一条都没配就是没配").isNull();
    }
    ...
    void ratesAreReplayedByTime() {
        ...
        assertThat(rates.effective(SysPayChannelRate.ANY, ch, "*", "*", 3_000L).rateBp())
                .as("3000 这一刻只有第一版生效").isEqualTo(38);
        assertThat(rates.effective(SysPayChannelRate.ANY, ch, "*", "*", 9_000L).rateBp())
                .as("调完之后取新版").isEqualTo(60);
        assertThat(rates.effective(SysPayChannelRate.ANY, ch, "*", "*", 500L))
    ...
    void exactBeatsWildcard() {
        ...
        assertThat(rates.effective(SysPayChannelRate.ANY, ch, "JSAPI", "ENTERPRISE", 2_000L).rateBp())
                .as("两维都精确命中").isEqualTo(20);
        assertThat(rates.effective(SysPayChannelRate.ANY, ch, "JSAPI", "MICRO", 2_000L).rateBp())
    ...
    void futureVersionIsScheduledNotActive() {
        ...
        assertThat(rates.effective(SysPayChannelRate.ANY, ch, "*", "*", now).rateBp())
