...
public interface MerchantService {
    ...
    ai.neargo.shop.merchant.dto.MerchantScoreVO score(String merchantNo);

    /** 我买过的商家（C-MC-01）。数据来自 trade 域，经 PurchaseHistoryPort。 */
    java.util.List<ai.neargo.shop.merchant.dto.VisitedMerchantVO> visited();
     ...
     */
    ai.neargo.shop.merchant.dto.MerchantAccountVO account(String merchantNo);
}
