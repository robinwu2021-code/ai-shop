...
import ai.neargo.shop.pay.entity.StlPurchaseInvoice;
...
public final class SettleMappers {
    ...
    public interface RiskShadowLogMapper
            extends BaseMapper<ai.neargo.shop.pay.entity.PayRiskShadowLog> {
    }

    public interface SettleBatchMapper
            extends BaseMapper<ai.neargo.shop.pay.entity.StlSettleBatch> {
    }
    ...
    public interface WithdrawMapper
            extends BaseMapper<ai.neargo.shop.pay.entity.StlWithdraw> {
    }
    ...
    public interface SettleInvoiceMapper
            extends BaseMapper<ai.neargo.shop.pay.entity.StlSettleInvoice> {
    }

    public interface FeeRuleMapper
            extends BaseMapper<ai.neargo.shop.pay.entity.StlFeeRule> {
    }
