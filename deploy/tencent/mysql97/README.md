...
> 状态：**三个业务库都在它上面跑；MariaDB 已 disable + mask** · 切换 2026-09-16 · 安装 2026-09-14
> 用途：现网唯一的数据库。**本目录只管「装上」**，切换过程与回滚见
> [`migrate/CUTOVER.md`](migrate/CUTOVER.md)（换存储属开发规范 2 档：PRD + TDD + ADR）。
