...
export const ENDPOINTS: Record<keyof MerchantApi, EndpointDef> = {
  ...
  mAddVillage: { method: "POST", path: "/biz/regions/village", auth: true, summary: "补录平台还没有的村/社区" },
  mResubmitVillage: { method: "POST", path: "/biz/regions/village/resubmit", auth: true, summary: "被驳回的补录改了再提" },
