    ...
    <Popover open={open} onOpenChange={(v) => void onOpenChange(v)}>
      <PopoverTrigger asChild>
        ...
        >
          ...
          {unread > 0 && (
            <span className="absolute -top-0.5 -end-0.5 flex h-4 min-w-4 items-center justify-center rounded-chip bg-destructive px-1 txt-caption leading-none text-white">
              {unread > 99 ? "99+" : unread}
            </span>
          )}
        </button>
