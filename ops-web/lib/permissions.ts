...
export const BACKEND_ROLE_PERMS: Record<string, string[]> = {
  ...
  PRODUCT_OPS: ["aftersale:refund:read", "aftersale:ticket:read", "community:community:read", "dashboard:overview:read", "group:campaign:audit", "group:campaign:read", "inventory:credential:read", "inventory:stock:read", "marketing:campaign:read", "marketing:campaign:update", "marketing:coupon:issue", "marketing:coupon:read", "marketing:coupon:update", "member:member:read", "member:person:read", "order:order:read", "product:category:read", "product:category:update", "product:sku:audit", "product:sku:read", "product:spec:read", "product:spec:update", "product:std:read", "product:std:update", "product:topic:read", "product:topic:update"],
