...
const zh = {
  ...
  colRgTime: "提报时间",
  filterRgStatus: "按状态筛",
  filterRgStatusAll: "全部",
  emptyRegion: "没有待确认的区划补录",
  btnRgPass: "通过并共享",
  btnRgReject: "驳回",
  secRgWhat: "补录内容",
  secRgDecide: "裁决",
  secRgRejected: "驳回原因",
  fieldRgCode: "区划码",
  phRgReason: "写清楚哪里不对，商家会原样看到",
  rgDupHint: "通过后这个村对全平台商家可见。先确认它不是既有村的另一个叫法。",
  rgReasonHint: "驳回必须写原因 —— 不写的话商家只会原样再提一次。他可以改了再提。",
  toastRegionApproved: "已通过，现在全平台可见",
  toastRegionRejected: "已驳回",
...
const en: typeof zh = {
  ...
  colRgName: "Village",
  colRgPath: "Region",
  colRgMerchant: "Submitted by",
  colRgStatus: "Status",
  colRgTime: "Submitted",
  filterRgStatus: "Filter by status",
  filterRgStatusAll: "All",
  emptyRegion: "No pending region entries",
  btnRgPass: "Approve & share",
  btnRgReject: "Reject",
  secRgWhat: "Entry",
  secRgDecide: "Decision",
  secRgRejected: "Reject reason",
  fieldRgCode: "Region code",
  phRgReason: "Say what is wrong — the merchant sees this verbatim",
  rgDupHint: "Once approved this village is visible to every merchant. Check it is not another name for an existing one.",
  rgReasonHint: "A reason is required — without one the merchant will just resubmit the same thing. They can edit and resubmit.",
  toastRegionApproved: "Approved — now visible platform-wide",
  toastRegionRejected: "Rejected",
