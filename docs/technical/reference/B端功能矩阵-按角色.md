...
- `/biz/inventory/suppliers/{no}/active`
...
- `/biz/store/{storeNo}/offline-sale`
- `/biz/store/{storeNo}/offline-sale/{docNo}/revoke`
...
- `/biz/member-reach/task`
- `/biz/member-reach/task/{taskNo}`
- `/biz/member-segments`
