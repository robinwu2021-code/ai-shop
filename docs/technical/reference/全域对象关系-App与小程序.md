...
> 定稿依据：[关系定稿](./账号主体门店-关系定稿.md) · [账号与多执照](./账号与多执照-设计.md) · [产品架构](./产品架构与实体关系.md)
...
| 门店换主体 | 可操作（六条硬约束 + 平台审核，[定稿 §3.4](./账号主体门店-关系定稿.md)） |
...
| 已在清单上 | 出处 |
|---|---|
| `activate` 幂等判据改按申请单（多主体阻塞，静默缺陷） | [定稿 §四](./账号主体门店-关系定稿.md) |
| 门店换主体接口 + 六条约束 + 数据处置 | [定稿 §3.4](./账号主体门店-关系定稿.md) + 本文 §5.1 |
| `usr_user_identity` 身份表（支付宝/多端） | [账号与多执照 §3](./账号与多执照-设计.md) |
| M3 选品与库存两表 | [数据库整理](./数据库整理-多门店与增长.md) |
