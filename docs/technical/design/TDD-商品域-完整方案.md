...
> **阅读入口（2026-08-28 起）**：V2.0 正式文档集在 [docs/technical/v2/](../v2/README.md)，按渐进披露组织；本册保留为决策记录。
...
| 文档 | 角色 |
|---|---|
| **本册** | **唯一入口与定稿候选**（决策、演进、闸门） |
| [商品域V2-设计规格书](./商品域V2-设计规格书.md) | **设计附件**：表结构终版、领域对象、Service 签名、API 报文、行业数据对标 |
